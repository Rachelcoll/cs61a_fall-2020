class VendingMachine:
    ...
    def restock(self, product_num):
        self.stock = self.stock + product_num
    ...
    def vend(self):
        if self.stock == 0:
            ...
            if self.balance > self.price:
                a = 'Here is your {1} and ${0} change.'.format(self.balance - self.price, self.product)
                self.balance = 0
